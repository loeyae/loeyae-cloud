node {
    ...
    stage("deploy") {
        ...
        def imageTag = "hub.dev.loeyae.com:30339/library/loeyae_service_center:${buildId}"
        def latestTag = "hub.dev.loeyae.com:30339/library/loeyae_service_center:latest"
