node {
    ...
    stage("deploy") {
        ...
        def imageTag = "hub.dev.loeyae.com:30339/library/loeyae_gateway:${buildId}"
    ...
    stage("Post") {
        if (currentBuild.currentResult == 'SUCCESS') {
            echo "sucess"
            build job: 'loeyae_gateway-deploy-prod', parameters: [text(name: 'IMAGE_TAG', value: BUILD_ID)], propagate: false, quietPeriod: 9, wait: false
        }
    }
}